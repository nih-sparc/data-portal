  ...
  <div id="dashboard">
    ...
    <el-row class="content-container">
      <el-col class="content-container__info">
        <div>WELCOME TO THE SPARC DATAPORTAL</div>
        <div>The Sparc Dataportal is an easily accessible resource to find, visualize and access data generated by the NIH SPARC project.</div>
      </el-col>
      <el-col>
        <sparc-datasets />
      </el-col>
